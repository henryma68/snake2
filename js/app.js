...
function setFood() {
  ...
  function main() {
	...
	canvas.width = COLS*19;
	canvas.height = ROWS*19;
...
function init() {
	...
	// that are pressed
	if (keystate==37 && snake.direction !== RIGHT) {
		snake.direction = LEFT;
	}
	if (keystate==38 && snake.direction !== DOWN) {
		snake.direction = UP;
	}
	if (keystate==39 && snake.direction !== LEFT) {
		snake.direction = RIGHT;
	}
	if (keystate==40 && snake.direction !== UP) {
